...
---
<Update label="July 8th, 2026" tags={["Organizations", "Profiles", "Frames", "MCP", "Dashboard"]}>

## Organizations, public builder profiles, and Nubo in your AI editor

A big one for how you work with others and how the world sees what you build. There's a proper ownership layer now with Organizations, a public profile for every builder, a Public or Private switch on each Frame, a redesigned console, and an MCP server so your AI tools can drive Nubo directly.

### Organizations

Your account now sits inside an Organization: a shared home for your Projects that more than one person can own.

- Give people a role in the org: **Member**, **Admin**, or **Owner**. Owners and Admins reach every Project the org owns.
- **Transfer ownership** when the person who should be in charge changes, without rebuilding anything.
- Everyone starts with a personal Organization that quietly owns the Projects you already have, so nothing you built moves or breaks.

### Public builder profiles

Every builder gets a public profile at **withnubo.com/@your-handle**. It shows your name, bio, avatar, when you joined, your public Frames, and your recent deployments, plus an activity heatmap of what you've been shipping. It's a simple way to point someone at what you've made without handing over your dashboard.

### Public or Private Frames

Each Frame now has a **visibility** setting in its Settings.

- **Private** is the default. Only people with access to the Project can see the Frame.
- **Public** Frames are the ones that appear on your profile page for anyone to find.
- Changing a Frame's visibility is an organization admin action, so what's public stays a deliberate choice.

### A redesigned console

The dashboard got a real overhaul focused on getting you where you're going faster.

- A **command palette** (hit ⌘K) to jump to any Project, Space, or Frame and run common actions from the keyboard.
- **Frame tabs** that keep Logs, Deployments, Volumes, Metrics, and Settings one click apart.
- A **widget rail** you can arrange to keep the things you check most within reach.

### The Nubo MCP server

You can now connect Nubo to your AI editor over the Model Context Protocol. Point **Claude Code, Claude Desktop, or Cursor** at the Nubo MCP server and it can inspect your Projects, Spaces, and Frames, trigger deployments, read build and runtime logs, and manage environment variables, all in plain language. Run it locally over stdio, or use the hosted server at `mcp.withnubo.com`, which signs you in with a browser and never holds your secrets.

Questions or feedback: `support@withnubo.com` or [Discord](https://discord.com/invite/4SM4faYqWQ).

</Update>

<Update label="July 3rd, 2026" tags={["Plans", "Bug-fixes"]}>
