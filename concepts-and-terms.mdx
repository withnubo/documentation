...
Volumes are blocks of persistent storage attached to a single Frame in a Project. Files written into a volume's mount path stick around across redeploys, rollbacks, and restarts. See [Volumes](/volumes).
