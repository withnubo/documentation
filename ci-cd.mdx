...
Nubo listens for pushes through the [Nubo GitHub App](https://github.com/apps/nubo-apps). Once it's installed on the account or organization that owns the repo, every Frame that tracks that repo gets push-based deploys out of the box.
...
You can customize the tags on the Frame's **CI/CD** tab if your team uses a different convention.
...
Patterns use shell-style globs. Configure them on the Frame's **CI/CD** tab.
