...
Private GitHub repositories work automatically, as long as the [Nubo GitHub App](https://github.com/apps/nubo-apps) is installed on the account with access to the repo.
