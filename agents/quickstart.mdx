...
In the dashboard, click **New Frame**. After picking your repo, you'll see a **Target** picker (Nubo Cloud plus a pill per connected agent): choose your agent instead of Nubo Cloud. An agent that's currently offline appears disabled in the picker, so make sure yours is online before you deploy.
