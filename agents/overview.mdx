...
<Frame>
  <img src="/images/agent-architecture.png" alt="Agent architecture diagram" />
</Frame>
...
4. Your Frame is served at its own subdomain on your domain, or at a [custom domain](/agents/custom-domains) you attach
...
<Card title="Custom domains" icon="globe" href="/agents/custom-domains">
