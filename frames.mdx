...
Rename, change the branch, or scale up the replica count from the Frame's **Settings** tab. None of these retriggers a deploy on their own - push a commit or hit **Deploy** when you're ready to roll the change out.
